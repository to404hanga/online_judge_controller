...
func InitSubmissionHandler(submissionSvc service.SubmissionService, minioSvc *minio.MinIOService, competitionSvc service.CompetitionService, l loggerv2.Logger) *web.SubmissionHandler {
	...
	return web.NewSubmissionHandler(minioSvc, submissionSvc, competitionSvc, l,
		cfg.Bucket,
