...
func InitProblemHandler(problemSvc service.ProblemService, minioSvc *minio.MinIOService, l loggerv2.Logger) *web.ProblemHandler {
	...
	return web.NewProblemHandler(problemSvc, minioSvc, l,
		cfg.ProblemBucket,
		cfg.TestcaseBucket,
