...
func InitScheduler(l loggerv2.Logger, problemSvc service.ProblemService, minioSvc *minio.MinIOService, submissionSvc service.SubmissionService) *job.CronScheduler {
